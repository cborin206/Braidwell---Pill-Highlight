...
var initFullpage = function initFullpage() {
  new fullpage('#fullpage', {
    licenseKey: '12A7934D-E8984E39-8E827848-14685098',
    scrollingSpeed: 600,
    navigation: true,
    ...
    onLeave: function onLeave(origin, destination) {
      var actualVideo = $('video')[origin.index];
      var nextVideo = $('video')[destination.index];

      if (destination.isLast) {
        document.body.classList.add('is-last');
      } else {
...
var setRoundedLogoBottomPosition = function setRoundedLogoBottomPosition() {
  var cookieBar = document.getElementById('cookie-law-info-bar');
  var acceptCookies = document.getElementById('wt-cli-accept-all-btn');
  var roundLogo = document.querySelector('.logo-rounded');
  var isCookieBarVisible = false;
  ...
  isCookieBarVisible && roundLogo.classList.add('cookies-bar-visible');
  acceptCookies && acceptCookies.addEventListener('click', function () {
    roundLogo.classList.remove('cookies-bar-visible');
  });
};
...
var initNavigationHover = function initNavigationHover() {
  setTimeout(function() {
    ...
    style.textContent = '.homepage #fp-nav ul li { transition: all 0.5s ease !important; transform-origin: center center !important; } .homepage #fp-nav ul li:hover { height: 7rem !important; }';
...
},{"../node_modules/fullpage.js/vendors/scrolloverflow.min.js":3,"fullpage.js":2,"jquery":4}],2:[function(require,module,exports){
/*!
 * fullPage 3.1.2
